    ...
    return (
        <>
            <div className='token_card'>
                ...
                <div className='info_logo_container'><div className='info_logo'><AiOutlineInfoCircle /></div></div>
            </div>
            <div className='token_card'>
                ...
                <div className='info_logo_container'><div className='info_logo tb'><TbHexagon3D /></div></div>
            </div>
            <div className='token_card'>
            ...
            <div className='token_card'>
                ...
                <div className='info_logo_container'><div className='info_logo bi'><BiDollar /></div></div>
            </div>
        </>
    )
}
